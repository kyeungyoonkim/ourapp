...
export const defaultData: AppData = {
  ...
  foodLogs: [
    ...
    { id: 'f6', menu: '갈비찜', date: '2026-06-27' },
  ],
  places: [
    {
      id: '1',
  ...
  memories: [
    {
      ...
      title: '찬 조지아 방문',
      description:
        '6/25–6/28 애크워스 Cauble Park에서 수영, 알파레타에서 갈비찜, 카터스빌에서 수영, 토이스토리 5 관람.',
      date: '2026-06-25',
      endDate: '2026-06-28',
      emoji: '🍑',
    },
  ...
  calendarEvents: [
    ...
    { id: 'c11', title: '찬 조지아 방문', startDate: '2026-06-25', endDate: '2026-06-28', type: 'visit', note: 'Cauble Park 수영 · 알파레타 갈비찜 · 카터스빌 수영 · 토이스토리 5' },
    { id: 'c14', title: 'BWI 방문', startDate: '2026-07-02', endDate: '2026-07-05', type: 'visit', note: '볼티모어' },
  ...
  packingList: [
    { id: 'p1', title: '여권/신분증', done: false, owner: 'shared', tripName: 'BWI 방문' },
    { id: 'p2', title: '기내용 7kg 백팩', done: false, owner: 'shared', tripName: 'BWI 방문' },
    { id: 'p3', title: '충전기·보조배터리', done: false, owner: 'shared', tripName: 'BWI 방문' },
    { id: 'p4', title: '캐리온 4일치 옷', done: false, owner: 'me', tripName: 'BWI 방문' },
    { id: 'p5', title: '선물', done: false, owner: 'me', tripName: 'BWI 방문' },
  ],
  diaryEntries: [
    {
      id: 'd1',
      ...
      title: '찬이랑 조지아에서',
      content:
        '6/25부터 6/28까지 찬이 와서 같이 보냈어. 애크워스 Cauble Park에서 수영하고, 알파레타에서 갈비찜 먹고, 카터스빌에서도 수영했어. 토이스토리 5도 같이 봤다 🎬',
      emoji: '🏊',
    },
  ],
  trash: [],
